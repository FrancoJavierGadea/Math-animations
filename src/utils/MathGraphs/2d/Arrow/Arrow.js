...
export class Arrow {
    ...
    update({start, end, endArrow, startArrow, size, delta} = {}){
        ...
        if(startArrow !== undefined) this.startArrow = startArrow;
        if(endArrow !== undefined) this.endArrow = endArrow;
